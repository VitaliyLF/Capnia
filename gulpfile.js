...
const paths = {
  ...
  pages: `${srcFolder}/${pagesFolder}/**/*.html`,
}
...
const htmlInclude = () => {
  return (
    src([`${srcFolder}/${pagesFolder}/*.html`])
      .pipe(
        fileInclude({
          prefix: '@',
          basepath: `${srcFolder}/${pagesFolder}`,
        })
      )
      // .pipe(
      //   typograf({
...
const watchFiles = () => {
  ...
  watch(`${srcFolder}/${pagesFolder}/**/*.html`, htmlInclude)
